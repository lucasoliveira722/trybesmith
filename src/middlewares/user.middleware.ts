...
const prodUsernameValidator = (req: Request, res: Response, next: NextFunction) => {
...
const prodClasseValidator = (req: Request, res: Response, next: NextFunction) => {
...
const prodLevelValidator = (req: Request, res: Response, next: NextFunction) => {
...
const prodPasswordValidator = (req: Request, res: Response, next: NextFunction) => {
